...
MVP（T-001〜T-034）完了後の追加要望です。**実装前に必ず仕様・権利を決めてから着手**してください。ここに書いたタスクはまだ実装していません。
...
- [ ] **T-100 追加機能の方針をSPEC/DECISIONSに固定する**
...
- [ ] **T-101 4 AIの表示名・handle・persona・役割マッピングを決める**
...
- [ ] **T-102 seed・personas・mention候補・UI文言を差し替える**
...
- [ ] **T-103 アバター画像を用意して `public/avatars` に配置する**
...
- [ ] **T-110 認証基盤とprofiles連携を設計・migrationする**
...
- [ ] **T-111 サインアップ・ログイン・ログアウトUIを実装する**
...
- [ ] **T-132 PostCard等からプロフィールへ遷移できるようにする**
